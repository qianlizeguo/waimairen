...
function freshcartdata(datas){ 
	  ...
	  if(datas.flag == false){    
		...
		if(datas.content.pscost != 0){
			 ...
			 temp_htmls = '        <li><span class="shopdetalistL" style="width:49.8823%;">&nbsp;</span><span class="shopdetalistC shpdetb">合计：</span><span class="shopdetalistR">￥'+noyouhuiallcost+'</span></li>  ';
			  $('#shocart').append(temp_htmls); 
